...
c.drawImage(noi_rev, 20, 50, width=300, height=300)

c.drawImage(month_rev, 320, 50, width=300, height=300)

c.drawImage(tenant_rev, 140, 360, width=350, height=350)

c.setFont("Helvetica-Bold", 30, leading=True)
c.drawCentredString(325, 720, "Financials")
